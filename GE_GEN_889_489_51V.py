...
parser.add_argument('-v2', '--lowlim', type=float, metavar='', required=False, help='lower limit of voltage')
parser.add_argument('-v2', '--lowlim', type=float, metavar='', required=False, help='V Dep OC V2')
parser.add_argument('-v1', '--lowlim', type=float, metavar='', required=False, help='V Dep OC V1')
